...
public class XEditText extends AppCompatEditText {
    ...
    private void init() {
        ...
        if (mRightMarkerDrawable == null) { // didn't customize Marker
            mRightMarkerDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_clear);
    ...
    private class MyTextWatcher implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (mXTextChangeListener != null) {
                mXTextChangeListener.onTextChanged(s.toString().toUpperCase(), start, before, count);
            }
        }
    ...
    public static class OnXTextChangeListenerAdapter implements OnXTextChangeListener {
